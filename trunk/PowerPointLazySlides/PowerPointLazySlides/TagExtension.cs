...
// TODO: this is a shameless copy from PowerPointLaTeX - remove this duplicate somehow [1/5/2009 Andreas]
// the files will be in the same repo - so is there any way to link them into this project?
// idea: partial classes to avoid having to specify the TagPrefix in a different way >_>
namespace PowerPointLazySlides
{
    static class TagExtension
    {
        private const string TagPrefix = "PowerPointLazySlides_";
